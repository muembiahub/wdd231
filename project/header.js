document.addEventListener('DOMContentLoaded', () => {
  ...
  emailLink.innerHTML = '<i class="fa-solid fa-envelope" style="color:#2196F3;"></i>contact@kazidomo.com';
  ...
  phoneLink.innerHTML = '<i class="fa-solid fa-phone" style="color:#4CAF50;"></i>+243 825 267 122';
